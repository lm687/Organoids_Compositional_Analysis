...
projDir <- "~/MyProjectsSvn/SvnRepoForStdRnaSeq/Brenton/ViasM/20191218_ViasM_BJ_orgaBrs"
projDir = "."
...
# GRCh37
# This is what we have to use because the copy number information is on GRCh37
# Not from kallisto
...
#setwd("GexVsCnGw") TPM
setwd("GexVsCnGwDeseq2_Lena") # DESeq2
...
# saveRDS(corDfAll, "../output/corDfAll.RDS")

# corDfAll = read.csv("../GexVsCnGwDeseq2/corStatTable.csv"); corDfAll = corDfAll[,-1]
