...
plot_rank = function(df_rank){
  ...
  ggplot(df_rank, aes(x=factor(Var1, as.character(Var1)[order(value)]),
    ...
    # geom_label_repel(data=df_rank, aes(x=factor(Var1, as.character(Var1)[order(value)]),
    #                   y=0, label=labels), vjust = 4)+
    # geom_label_repel(data=df_rank, aes(x=factor(Var1, as.character(Var1)[order(value)]),
    #                   y=value/2, label=labels))+
    geom_label_repel(data=df_rank[c(T,F),], aes(x=factor(Var1, as.character(Var1)[order(value)]),
                      y=value/2, label=labels), vjust=4)+
