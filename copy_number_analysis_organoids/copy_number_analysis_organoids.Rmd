...
```{r, compare_amplification, dependson=c('annotate_genes')}
# data("geneInfo")
...
```{r, compare_amplification_generalised, echo=FALSE, eval=TRUE, dependson=c('compare_amplification')}
...
```{r, heatmap_ampldel_organoids, dependson=c('compare_amplification_generalised')}
...
```{r, heatmap_ampldel_organoids_v2, dependson=c('compare_amplification_generalised')}
...
```{r, heatmap_ampldel_organoids_v2_b, dependson=c('heatmap_ampldel_organoids_v2')}
...
```{r, gene_ploidy_cosmic_plot, echo=FALSE, dependson=c('correlation_rnaseq_absoluteCN')}
names(ploidies)
names(ploidies[[1]])
...
```{r, plot_cosmic, echo=FALSE, dependson=c('gene_ploidy_cosmic_plot')}
...
```{r, genes_discrete_organoids_ampdel, echo=FALSE, dependson=c('plot_cosmic', 'gene_ploidy_cosmic_plot')}
