...
```{r, cn_regions_subclonal, echo=FALSE}
...
```{r, cn_regions_subclonal_individual, echo=FALSE}
...
```{r, cn_regions_subclonal2, echo=FALSE, dependson=c('cn_regions_subclonal', 'cn_regions_subclonal_individual')}
...
```{r, cn_regions_subclonal3, dependson=c('cn_regions_subclonal2'), echo=FALSE}
do.call('grid.arrange', c(sapply(plts_AOI_subclonal, `[`, 2), list(nrow=2)))
```

```{r, cn_regions_subclonal4, dependson=c('cn_regions_subclonal2')}
