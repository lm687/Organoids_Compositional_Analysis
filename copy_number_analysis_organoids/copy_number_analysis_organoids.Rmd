...
give_dendrogram_from_imputation <- function(impute_VALUE){
  dendroimputclr_all_lowerinput = give_dendrogram_generalised(as(compositions::clr(impute(all_natgen[[which_natgen]], impute_VALUE)), 'matrix'), modify_labels=F, keep_only_PDO = F)
  ...
  heatmap_dendrogram_df_inputclr0004 = t(all_natgen$UpdatedExposures[rownames(all_natgen$UpdatedExposures)[match(gsub("Organoid ", "", labels(dendroimputclr_all_lowerinput)),rownames(all_natgen$UpdatedExposures))],])
